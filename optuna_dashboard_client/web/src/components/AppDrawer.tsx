...
import { drawerOpenState, reloadIntervalState, useStudyIsPreferencial } from "../state";
...
export const AppDrawer: FC<{
  ...
  const isPreferential = studyId !== undefined ? useStudyIsPreferencial(studyId) : null;
        ...
        {studyId !== undefined && page && (
          <List>
            <ListItem key="Top" disablePadding sx={styleListItem}>
              <ListItemButton
                component={Link}
                to={`${import.meta.env.VITE_URL_PREFIX}/studies/${studyId}`}
            ...
            {isPreferential && (
              <ListItem key="PreferenceHistory" disablePadding sx={styleListItem}>
                <ListItemButton
                  component={Link}
                  to={`${import.meta.env.VITE_URL_PREFIX}/studies/${studyId}/preference-history`}
                  sx={styleListItemButton}
                ...
                >
                  ...
                  <ListItemText primary="Preferences (History)" sx={styleListItemText} />
                </ListItemButton>
              </ListItem>
            )}
            <ListItem key="Analytics" disablePadding sx={styleListItem}>
              <ListItemButton
                component={Link}
                to={`${import.meta.env.VITE_URL_PREFIX}/studies/${studyId}/analytics`}
                sx={styleListItemButton}
            ...
            {isPreferential && (
              <ListItem key="PreferenceGraph" disablePadding sx={styleListItem}>
                <ListItemButton
                  component={Link}
                  to={`${import.meta.env.VITE_URL_PREFIX}/studies/${studyId}/graph`}
                  sx={styleListItemButton}
                  selected={page === "graph"}
                >
                  <ListItemIcon sx={styleListItemIcon}>
                  ...
                  <ListItemText primary="Preferences (Graph)" sx={styleListItemText} />
                </ListItemButton>
              </ListItem>
            )}
            <ListItem key="TableList" disablePadding sx={styleListItem}>
              <ListItemButton
                component={Link}
                to={`${import.meta.env.VITE_URL_PREFIX}/studies/${studyId}/trials`}
                sx={styleListItemButton}
            ...
            <ListItem key="TrialTable" disablePadding sx={styleListItem}>
              <ListItemButton
                component={Link}
                to={`${import.meta.env.VITE_URL_PREFIX}/studies/${studyId}/trialTable`}
                sx={styleListItemButton}
            ...
            <ListItem key="Note" disablePadding sx={styleListItem}>
              <ListItemButton
                component={Link}
                to={`${import.meta.env.VITE_URL_PREFIX}/studies/${studyId}/note`}
                sx={styleListItemButton}
                selected={page === "note"}
              >
                <ListItemIcon sx={styleListItemIcon}>
