...
export const StudyList: FC<{
  ...
  const initialSortBy = query.get("studies_order_by") === "desc" ? "desc" : "asc";
        ...
        >
            ...
            <CardContent>
              <Box sx={{ display: "flex" }}>
                ...
                <Button
                  ...
                  component={Link}
                  to={`${import.meta.env.VITE_URL_PREFIX}/compare-studies`}
                  sx={{ marginRight: theme.spacing(2), minWidth: "120px" }}
                >
                  Compare
                </Button>
          ...
          <Box sx={{ display: "flex", flexWrap: "wrap" }}>
            {filteredStudies.map((study) => (
              <Card key={study.study_id} sx={{ margin: theme.spacing(2), width: "500px" }}>
                <CardActionArea
                  component={Link}
                  to={`${import.meta.env.VITE_URL_PREFIX}/studies/${study.study_id}`}
                >
                  <CardContent>
                    ...
                    <Typography variant="subtitle1" color="text.secondary" component="div">
                      {study.is_preferential
                        ...
                        : "Direction: " +
                          study.directions.map((d) => d.toString().toUpperCase()).join(", ")}
                    </Typography>
                  </CardContent>
                </CardActionArea>
