...
export const TrialNote: FC<{
  ...
  return <NoteBase studyId={studyId} trialId={trialId} latestNote={latestNote} cardSx={cardSx} />;
};
...
const useConfirmCloseDialog = (handleClose: () => void): [() => void, () => React.ReactNode] => {
  ...
  const renderDialog = () => {
    return (
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>Do you want to save or discard your changes?</DialogContentText>
        </DialogContent>
        <DialogActions>
    ...
    >
      <CardHeader
        action={
          ...
          >
            {preview ? <ModeEditIcon color="primary" /> : <HtmlIcon color="primary" />}
          </IconButton>
        }
      ...
      <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
        {notLatest && !saving && (
          <>
            ...
            >
              The text you are editing has updated. Do you want to discard your changes and refresh
              the textarea?
            </Typography>
            <Button
              variant="text"
        ...
        <ImageList cols={1} sx={{ margin: 0 }}>
          {artifacts
            ...
            .map((a) => (
              ...
              >
                <img src={`/artifacts/${studyId}/${trialId}/${a.artifact_id}`} />
